...
class Company {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'employee_cancel_message': employeeCancelMsg,
      'appointment_reminder_message': aptReminderMsg
    };
  }
  ...
  Company.fromMap(Map snapshot)
      : id = snapshot['id'],
        ...
        employeeCancelMsg = snapshot['employee_cancel_message'],
        aptReminderMsg = snapshot['appointment_reminder_message'];
